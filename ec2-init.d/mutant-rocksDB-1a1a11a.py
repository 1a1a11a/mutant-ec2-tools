...
#	Util.RunSubp("git clone https://github.com/1a1a11a/mongo /mnt/local-ssd0/mutant/mongo")
#
#	# Symlink
...
#	# Edit the git source repository for easy development.
#	Util.RunSubp("sed -i 's/" \
#			"^\\turl = https:\\/\\/github.com\\/1a1a11a\\/mongo" \
#			"/\\turl = git@github.com:1a1a11a\/mongo.git" \
